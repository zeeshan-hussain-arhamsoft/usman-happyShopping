		...
		<section id='shopping-cart-content'>
			...
			<Container>
				...
				<div className='checkout-buttons'>
					<Link to='/' className='hvr-bounce-in continue-shopping-btn checkout-btn'>Continue Shopping</Link>
					<Link to='/' className='hvr-bounce-in checkout-btn'>Proceed to Checkout</Link>
				</div>
			</Container>
		</section>
	);
